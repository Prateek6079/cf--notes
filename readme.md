...
36. C. Combination Lock [https://codeforces.com/contest/2091/problem/C] #22mins #1000
    ...
    insight : It is not possible for odd numbers because in all cyclic states one number is at it's position and the others are either relatively ahead or behind and no two numbers can be the exactly the same places ahead or behind because then if we shift for one shift they both will be at the right position,  ......
